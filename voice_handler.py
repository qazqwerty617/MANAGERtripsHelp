...
6. СПОЛУЧНИК & В НАЗВАХ: У назвах готелів ЗАВЖДИ замінюй слова "and", "та", "и", "i", "й", "энд", "енд" на символ "&", якщо вони розділяють слова в назві готелю (наприклад: "Kassavetis Center - Hotel Studios & Apartments", "Hotel Torre Azul & Spa"). Звіряйся з наданим довідником готелів для точного написання назви!
7. ХАРЧУВАННЯ: Не видаляй тип харчування (сніданки, все включено тощо).
8. НЕ ВИГАДУЙ назви готелів, яких не було в тексті!
9. Все крім готелів (дати, рейси, ціна авіа, послуги) — залиш одним абзацом на початку.
"""
