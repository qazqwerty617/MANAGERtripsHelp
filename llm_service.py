...
Твоє завдання: знайти у тексті менеджера ВСІ згадані готелі і витягнути їх назви ТОЧНО ТАК, ЯК ВОНИ НАПИСАНІ В ТЕКСТІ.
...
3. КАТЕГОРИЧНО ЗАБОРОНЕНО ВИПРАВЛЯТИ НАЗВИ! Витягуй назву готелю символ-в-символ так, як вона написана у тексті (навіть якщо там є одруківки). Нічого не змінюй і не придумуй.
4. ОЧИЩЕННЯ: Видали тільки ціни та типи харчування. Сама назва готелю має залишитись без змін.
5. ФОРМАТ: Тільки JSON {"hotels": ["Name 1", "Name 2", "Name 3"]}. Жодного іншого тексту.
"""
